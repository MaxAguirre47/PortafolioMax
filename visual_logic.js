...
registerOnClick('Z1TV', false, false, [0,1,2], false, function(event) {
    tweenCamera('A2KAMARA', 'A2DIREKSION', 2, function() {}, 1);
    registerOnClick('Z1TV', false, false, [0,1,2], false, function(event) {
        tweenCamera('A1KAMARA', 'A1DIREKSION', 2, function() {}, 1);
    }, function(event) {});
}, function(event) {});

registerOnClick('HAFICHE1', false, false, [0,1,2], false, function(event) {
    tweenCamera('A3KAMARA', 'A3DIREKSION', 2, function() {}, 1);
}, function(event) {});
registerOnClick('HAFICHE1', false, false, [0,1,2], false, function(event) {
    tweenCamera('A1KAMARA', 'A1DIREKSION', 2, function() {}, 1);
}, function(event) {});
registerOnClick('HAFICHE2', false, false, [0,1,2], false, function(event) {
    tweenCamera('A3KAMARA', 'A3DIREKSION', 2, function() {}, 1);
}, function(event) {});
registerOnClick('HAFICHE2', false, false, [0,1,2], false, function(event) {
    tweenCamera('A1KAMARA', 'A1DIREKSION', 2, function() {}, 1);
}, function(event) {});
registerOnClick('HAFICHE3', false, false, [0,1,2], false, function(event) {
    tweenCamera('A3KAMARA', 'A3DIREKSION', 2, function() {}, 1);
}, function(event) {});
registerOnClick('HAFICHE3', false, false, [0,1,2], false, function(event) {
    tweenCamera('A1KAMARA', 'A1DIREKSION', 2, function() {}, 1);
...
registerOnClick('Plane.001', false, false, [0,1,2], false, function(event) {
    tweenCamera('A4KAMARA', 'A4DIREKSION', 2, function() {}, 1);
}, function(event) {});
registerOnClick('Plane.001', false, false, [0,1,2], false, function(event) {
    tweenCamera('A1KAMARA', 'A1DIREKSION', 2, function() {}, 1);
}, function(event) {});

registerOnHover('<none>', false, function(event) {
...
CLICK = 'ON';
VIDEO = loadVideo('https://raw.githack.com/MaxAguirre47/PORTAFOLIO/main/STOPMOTION.mp4');
registerOnClick('Plane', false, false, [0,1,2], false, function(event) {
    if (CLICK == 'ON') {
        replaceTexture('Material.020', 'TV70s_Material_Normal_003.png', VIDEO, false, function() {});
